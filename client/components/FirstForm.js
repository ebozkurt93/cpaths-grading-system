                  ...
                  <fieldset disabled={loading}>
                    ...
                    <div className='form-group'>
                      <label htmlFor='longQuestion1' className='form-label'>
                        ...
                        detaylı bir şekilde açıklayabilir misin? Yurt dışında
                        staj yapmak istiyorum veya X şirketinde çalışmak
                        istiyorum gibi yüzeysel cevaplar maalesef başvurunu
                        güçsüz gösterecek. Hangi spesifik alanda staj yapmak
                        istediğinden veya X şirketinde hangi pozisyonda çalışmak
                        istediğinden açık ve net bir şekilde bahsetmelisin :)
                      </label>
                      <textarea
                        required
                        placeholder=' '
                    ...
                    <div className='form-group'>
                      <label htmlFor='longQuestion2' className='form-label'>
                        ...
                        önce hedefine yönelik bir çalışma yapmadıysan da hiç
                        sorun değil, diğer soruya geçebilirsin; bu başvurunu
                        güçsüz göstermeyecek ;)
                      </label>
                      <textarea
                        required
                        placeholder=' '
                    ...
                    <div className='form-group'>
                      <label htmlFor='longQuestion3' className='form-label'>
                        Seni bu hedefe götüren yolu bize kısaca anlatabilir
                        misin? Biraz ilham için:{' '}
                        <a href='https://goo.gl/Ug74nM'>
                          https://goo.gl/Ug74nM
                        </a>{' '}
                        (Geçmiş çalışmaların veya tecrübelerin, neden bu
                        alanlarda devam etmek istediğin/istemediğin, tanıştığın
                        bir kişi veya ilham aldığın bir başarı hikayesinden
                        bahsedebilirsin!)
                      </label>
                      <textarea
                        required
                    ...
                    <div className='form-group'>
                      <label htmlFor='longQuestion4' className='form-label'>
                        ...
                        musun? Bu soru başvuru değerlendirmeni etkilemeyecek,
                        ama son bir gayret max. bir kaç dk. ayırıp bu soruyu da
                        samimi şekilde cevaplamanı rica ediyoruz :)
                      </label>
                      <textarea
                        required
                        placeholder=' '
                    ...
                    <div className='form-group'>
                      <label className='form-label'>
                        Yukarıda vermiş olduğum bilgilerin doğruluğunu ve
                        herhangi bir tutarsızlığın veya yanlışlığın
                        doğurabileceği sonuçların yükümlülüğünü kabul ediyorum.
                        Bu belgeyi tamamlayarak; Kariyer Koçum programına
                        başvuru yaptığımın ve kabul edilmem durumunda danışan
                        olmanın kurallarını onayladığımın farkındayım. Danışan
                        olarak, Kesişen Yollardan herhangi bir maddi gelir
                        beklemediğimi, oluşumla bağım devam ettiği sürece
                        yukarıdaki bilgilerimden herhangi birinin değişiminde
                        gerekli kişileri bilgilendireceğimi, danışmanım veya
                        koçum ile aramdaki ilişkinin mahremiyetine saygı
                        gösteriyor olmak ile birlikte gerekli durumlarda Kesişen
                        Yollar platformu ile iletişime geçeceğimi onaylıyorum.
                        Kariyer Koçum ile etkileşimim sürecinde bireysel
                        özgürlük sınırlarını aşmayacağımı, karşı tarafın isteği
                        olmadan herhangi bir konu üzerinde durmayacağımı, özel
                        hayatla ilgili ve siyasi ve dini hassasiyetlere dikkat
                        edeceğimi kabul ediyorum. Kesişen Yollar’a başvurmanın
                        hukuki akıbetlerinin bilincindeyim: (a) Kesişen Yollar
                        derneğini herhangi bir hukuksal açıdan dolayı sorumlu
                        tutmayacağım. (b) Kesişen Yollar derneğine, danışan veya
                        danışmanlarına ve koçum’a dava açmayacağım. (c) Bu
                        programa katılmanın tüm risklerinin bilincindeyim. (d)
                        Bu programa dahil olarak paylaştığım bilgilerin
                        danışmanlık programı iç sosyal ağında paylaşılmasını ve
                        diğer üyeler ve Kesişen Yollar çalışanları tarafından
                        görülmesini onaylıyorum. (e-mail adresi gizli
                        tutulacaktır.)
                      </label>
